...
const emailConfig = require('../../config/keys').email
...
<div style="border: 1px solid #555;border-radius: 5px;padding: 2vw 5vw 0.5em 5vw;color: #555;width: 80%;">
    <div class="head" style="border-bottom: 1px solid #555; padding-bottom: 10px">
      <a href="http://localhost:3000"
        ><img
          src="https://i.postimg.cc/HsMLtjrD/logo.jpg"
          alt="Food plate"
          width="100px"
    ...
    <p>
      ...
      <a href="/">support@foodmart.com</a> to enable us disable the
      account.
    </p>
    <p>
      Thanks, <br />
    ...
    <hr />
    <small>&copy; 2022 Food Mart</small>
  </div></div>
`
...
const emailVerification = async({name, email, url}) => {
    const message = msg
    return sendEmail({
        from: `Eddy Food Mart <${emailConfig.user}>`,
        to: email,
